...
def get_chatroom_details(chatroom_name):
    try:
        ...
        return create_error_response("GET_DETAILS_FAILED", str(e), 500)
...
def create_chatroom():
    ...
    try:
        ...
        return create_error_response("CREATE_CHATROOM_FAILED", f"Failed to create chatroom: {e}", 500)
...
def delete_chatroom(chatroom_name):
    ...
    try:
        ...
        return create_error_response("DELETE_CHATROOM_FAILED", f"Failed to delete chatroom: {e}", 500)
    ...
    try:
        ...
        if not os.path.exists(old_path) and os.path.exists(new_path):
            try:
                ...
                pass
        return create_error_response("RENAME_CHATROOM_FAILED", f"Failed to rename chatroom: {e}", 500)